 ...
 * The class provides different methods to validate the data from the forms, an static function to get all the data from the database or a method to clean the data
 */
