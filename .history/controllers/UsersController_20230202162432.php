...
class UsersController {
     ...
     * @param string $password Password retrieved from the form to check if is equal to @
     * @param string $passwordConfirm Repeated password retrieved from the form to be handle
     * @param string $nid Email retrieved from the form to be handle
     * @return void
     */
