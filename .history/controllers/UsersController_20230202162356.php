...
class UsersController {
    ...
    /**
     * Get and clean the data from the form
     * @param string $email Email retrieved from the form to be handl
     * @param string $password The form data to be cleaned and passing to the model
     * @param string $passwordConfirm The form data to be cleaned and passing to the model
     * @param string $nid The form data to be cleaned and passing to the model
     * @return void
     */
