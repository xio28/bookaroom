...
## Description
**BookARoom** BookARoom is a website that was born from a class project whose goal was to learn how to develop a project from scratch correctly, using current technologies, learn how to handle databases, and orient ourselves in OOP.
