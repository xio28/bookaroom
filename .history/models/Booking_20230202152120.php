 ...
 */
This is the code for a PHP class named "Booking". The class implements the "CrudInterface" and provides methods for creating, reading, updating and deleting data from a "booking" database table.
/**
 * Create a namespace
 */
