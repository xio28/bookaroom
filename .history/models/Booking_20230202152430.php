...
class Booking implements CrudInterface {
    ...
    /**
     * Class constructor
     * This constructor initializes the class property $conn by calling the static method getInstance on the Connection class and then calling the method getConnection on the result.
    Additionally, it calls the method create on $this.
    */
