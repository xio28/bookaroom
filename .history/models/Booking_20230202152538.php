...
class Booking implements CrudInterface {
    ...
    /**
     * Class constructor
     * This constructor initializes the class property $conn by calling the static method getInstance on the Connection class and then calling the public method getConnection on the result, thus $
