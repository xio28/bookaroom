...
class Booking implements CrudInterface {
    ...
    It sets the class property "conn" to the result of calling the static method "getInstance" on the "Connection" class,
    and then calls the method "getConnection" on the result.
    Then, it calls the method "create" on "this" object.
    */
