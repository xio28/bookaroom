<?php
     ...
     * Have several modals for insert, update and delete; rooms can be inserted through a modal form as well as updated or deleted and users and reservations can be 
