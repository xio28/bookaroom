 ...
 * The function simply echoes a string with the HTML for a footer that includes several JavaScript files, such as bootstraps and JQuery libraries, and an sidebar 
 */
