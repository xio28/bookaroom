 ...
 * The function have a string argument which is  echoes a string with the HTML head that includes several Bootstrap, icons, fonts, favicon links, and also a local main css
 */
