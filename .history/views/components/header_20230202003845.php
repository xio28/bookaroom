 ...
 * The function have a parameter that echoes a string with the HTML head that includes several Bootstrap, icons, fonts, favicon links, and also a local main css
 */
