 ...
 * The function echoes a string with the HTML head that includes several JavaScript files, such as bootstraps and JQuery libraries, and a script for a sidebar
 */
