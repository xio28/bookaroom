 ...
 * The function echoes a string with the HTML head that includes several Bootstrap links, such as bootstraps and JQuery libraries, and a script for a sidebar
 */
