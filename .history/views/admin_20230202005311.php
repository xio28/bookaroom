...
<?php 
    /**
     * Generates modals for updating and deleting customers
     * 
     * @param array $customersTb An array of customer information
     */
...
<?php
     ...
     * 
     * @param array $roomTb An array of room information
     */
    if(!empty($roomTb)) :
...
<?php 
    /**
     * Generates modals for updating and deleting book
     * 
     * @param array $bookingTb An array of room information
     */
    if(!empty($bookingTb)) :
