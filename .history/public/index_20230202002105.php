<?php
    ...
    switch($resource) {
        ...
        case 'signup':
            /**
             * Shows the signup template and handles, using the `UsersController` method `handler`, the user registration
             */
        ...
        case 'booking':
            /**
             * Shows the booking template and handles the user reservations
             */
