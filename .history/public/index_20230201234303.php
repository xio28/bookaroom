<?php
    ...
    /**
     * Create new instances of the `UsersController`, `RoomsController`, `LoginController`, `LoginController`
     */
    ...
    /**
     * Renders the template based on the provided resource
     *
    ...
    switch($resource) {
        ...
        case 'admin':
            /**
             * Renders the admin template if the user is logged in as an admin
             * If the user is not logged in or is not an admin, redirects to the login page
             */
        ...
        case 'signup':
            /**
             * Renders the signup template and handles the user registration
             */
